...
If the OpenAPI document is large, imports in dj_python_client.apis and dj_python_client.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from dj_python_client.apis.default_api import DefaultApi`
...
import dj_python_client
from dj_python_client.apis import *
from dj_python_client.models import *
```
